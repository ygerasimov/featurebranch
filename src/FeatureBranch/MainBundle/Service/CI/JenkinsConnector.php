...
<<<<<<< HEAD
  ...
  public function updateBranch($branch) {
    ...
    // Getting all variables for sniffer from config.yml
    $sniffer_extensions = $this->container->getParameter('feature_branch.sniffer_extensions');
    $sniffer_ignore_patterns = $this->container->getParameter('feature_branch.sniffer_ignore_patterns');
    $sniffer_standard = $this->container->getParameter('feature_branch.sniffer_standard');
    $sniffer_report_file = $this->container->getParameter('feature_branch.sniffer_report_file');
    $phing_config = $this->container->get('templating')->render(
      'FeatureBranchMainBundle::phing.build.update.xml.twig', [
      'branch' => $branch,
      'apache_root' => $apache_root,
      'sniffer_extensions' => $sniffer_extensions,
      'sniffer_ignore_patterns' => $sniffer_ignore_patterns,
      'sniffer_standard' => $sniffer_standard,
      'sniffer_report_file' => $sniffer_report_file,
    ]);
    ...
    $jenkins_config = $this->container->get('templating')->render(
      ...
      'phing_config_tasks' => 'git_pull update_database sniff',
    ]);
  ...
  public function createHost($branch, $origin_branch) {
    ...
    $jenkins_config = $this->container->get('templating')->render(
      'FeatureBranchMainBundle::jenkins.config.xml.twig', [
      'phing_config_filename' => $phing_filename,
      'phing_config_tasks' => 'git_clone files_directory copy_settings.php modify_settings.php create_db copy_db sniff',
    ]);
...
>>>>>>> d71e7b463e2d8d2867afb4eacf3fd2d3400e9bde
}
